...
At this point, Flatiron should provide lots of guidance re: rbenv, Homebrew and other workarounds, for sandboxing a Ruby environment apart from Apple's system Ruby.  There are many suggested workarounds on GitHub and StackOverflow for this error message: "You don't have write permissions for the /Library/Ruby/Gems/2.0.0 directory."
